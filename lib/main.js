...
const KeyVaultHelper2_1 = require("./KeyVaultHelper2");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (actionParameters.apiVersion == "v2") {
                var keyVaultHelper2 = new KeyVaultHelper2_1.KeyVaultHelper2(actionParameters);
                keyVaultHelper2.downloadSecrets();
            }
            else {
                let handler = null;
                try {
                    handler = yield AuthorizationHandlerFactory_1.getHandler();
                }
                catch (error) {
